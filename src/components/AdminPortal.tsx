...
export default function AdminPortal({ overview }: { overview: AdminOverview }) {
  ...
  return (
    <main className="min-h-screen bg-black px-4 pb-12 pt-24 text-white sm:px-6">
      <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[220px_1fr]">
        ...
        <div className="min-w-0">
          ...
          <section id="orders" className="mt-10"><h2 className="font-cinzel text-xl">Orders</h2><p className="mt-2 text-sm text-white/55">{overview.orderCount} orders are available for review. Fulfilment workflow is introduced in the orders milestone.</p></section>
