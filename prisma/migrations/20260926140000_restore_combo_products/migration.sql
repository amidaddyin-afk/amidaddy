-- Production never received the combo catalogue (20260810130000_combo_catalog):
-- no 'combos' category, no combo products, no combo variants. The storefront
-- showed the discovery set from the built-in fallback data, but checkout prices
-- every line from product_variants by uuid, so neither combo could be bought and
-- /products/signature-combo-100ml was a 404.
--
-- Idempotent: every statement upserts, so it is safe to run more than once.
-- STOCK: 20 and 12 are the original seed numbers. Set real stock in the admin
-- portal after running this.
...
from (values
  ...
  ('signature-combo-100ml', '100ml', 'AMI-COMBO-100-100', 289900, 599600, 12)
...
from (values
  ('signature-combo-20ml', '/combos/discovery-4x20ml/pack.webp', 'All four Amidaddy fragrances in 20 ml bottles', 0, null),
  ('signature-combo-20ml', '/combos/discovery-4x20ml/gallery-01.webp', 'The four-fragrance 20 ml discovery set', 1, '20ml'),
  ('signature-combo-20ml', '/combos/discovery-4x20ml/gallery-02.webp', 'The discovery set, detail', 2, '20ml'),
  ('signature-combo-100ml', '/combos/collection-4x100ml/pack.webp', 'All four Amidaddy fragrances in 100 ml bottles', 0, null),
  ('signature-combo-100ml', '/combos/collection-4x100ml/pack-wide.webp', 'The four 100 ml bottles side by side', 1, '100ml'),
  ('signature-combo-100ml', '/combos/collection-4x100ml/gallery-01.webp', 'Four fragrance 100 ml combo', 2, '100ml'),
  ('signature-combo-100ml', '/combos/collection-4x100ml/gallery-02.webp', 'Four fragrance 100 ml combo detail', 3, '100ml'),
  ('signature-combo-100ml', '/combos/collection-4x100ml/gallery-03.webp', 'Four fragrance 100 ml combo arrangement', 4, '100ml'),
  ('signature-combo-100ml', '/combos/collection-4x100ml/gallery-04.webp', 'Complete four fragrance 100 ml set', 5, '100ml')
